...
//act as event listener for the db
//takes 2 param: name of IDB db to create and db version, default = 1
const request = indexedDB.open("pizza-hunt-for-pizza-lovers", 1);
...
function uploadPizza() {
  ...
  //async fxn that must be attached to event addEventListener
